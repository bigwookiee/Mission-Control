...
namespace SerialPortTerminal
{
    class AirSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(SerialPortTerminal.Properties.Resources.AirSpeedNeedle);
