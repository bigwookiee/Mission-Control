...
namespace SerialPortTerminal
{
    class VerticalSpeedIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(SerialPortTerminal.Properties.Resources.VerticalSpeedNeedle);
        #endregion
