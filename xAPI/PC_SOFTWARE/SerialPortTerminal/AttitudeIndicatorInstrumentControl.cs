...
namespace SerialPortTerminal
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(SerialPortTerminal.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(SerialPortTerminal.Properties.Resources.Maquette_Avion);
