...
namespace SerialPortTerminal
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(SerialPortTerminal.Properties.Resources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(SerialPortTerminal.Properties.Resources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(SerialPortTerminal.Properties.Resources.Bandeau_Dérouleur);
