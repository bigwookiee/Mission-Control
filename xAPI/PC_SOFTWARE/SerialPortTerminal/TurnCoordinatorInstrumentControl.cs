...
namespace SerialPortTerminal
{
    class TurnCoordinatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(SerialPortTerminal.Properties.Resources.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(SerialPortTerminal.Properties.Resources.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(SerialPortTerminal.Properties.Resources.TurnCoordinatorMarks);
