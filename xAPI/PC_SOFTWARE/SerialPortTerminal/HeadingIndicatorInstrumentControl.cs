...
namespace SerialPortTerminal
{
    class HeadingIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(SerialPortTerminal.Properties.Resources.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(SerialPortTerminal.Properties.Resources.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(SerialPortTerminal.Properties.Resources.HeadingIndicator_Aircraft);        
